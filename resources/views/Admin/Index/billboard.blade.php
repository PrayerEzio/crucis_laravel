                        ...
                        <div class="feed-activity-list">
                            ...
                            <div class="feed-element">
                                <a href="profile.html" class="pull-left">
                                    <img alt="image" class="img-circle" src="{{ asset('assets/Admin') }}/img/profile.jpg">
                                </a>
                            ...
                            <div class="feed-element">
                                <a href="profile.html" class="pull-left">
                                    <img alt="image" class="img-circle" src="{{ asset('assets/Admin') }}/img/a2.jpg">
                                </a>
                                <div class="media-body ">
                            ...
                            <div class="feed-element">
                                <a href="profile.html" class="pull-left">
                                    <img alt="image" class="img-circle" src="{{ asset('assets/Admin') }}/img/a3.jpg">
                                </a>
                                <div class="media-body ">
                            ...
                            <div class="feed-element">
                                <a href="profile.html" class="pull-left">
                                    <img alt="image" class="img-circle" src="{{ asset('assets/Admin') }}/img/a5.jpg">
                                </a>
                                <div class="media-body ">
...
<script src="{{ asset('assets/Admin') }}/js/demo/peity-demo.min.js"></script>
...
<script src="{{ asset('assets/Admin') }}/js/demo/sparkline-demo.min.js"></script>
<script>
