...
<div class="row  border-bottom white-bg dashboard-header">
    ...
    <div class="col-sm-3">
        ...
        <br>
        <br>
        <img src="{{ asset('assets/Admin') }}/img/qr_code.png" width="100%" style="max-width:264px;">
        <br>
    </div>
    <div class="col-sm-5">
        <h2>
        ...
        <div class="col-sm-4">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <p id="pay-qrcode">
                        <a href="javascript:;"><img src="{{ asset('assets/Admin') }}/http://cdn.zi-han.net/theme/hplus/pay.png?922" width="100%" alt="请使用手机支付宝或者微信扫码支付">
                        </a>
                    </p>
...
<script src="{{ asset('assets/Admin') }}/js/content.min.js"></script>
<script src="{{ asset('assets/Admin') }}/js/welcome.min.js"></script>
</body>
